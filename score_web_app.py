...
st.sidebar.markdown('Analista de Política de Riscod e Crédito')
st.sidebar.markdown('#### Projeto de modelagem')
st.sidebar.markdown("- [Artigo de Desenvolvimento no Medium](https://brc-deep-analytics.medium.com/machine-learning-para-credit-scoring-5a4d1b7188c7)") 
